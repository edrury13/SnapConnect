...
Provides higher-level operations that combine OpenAI and Pinecone via LangChain.
"""
...
class LangChainService:
    ...
    def __init__(self):
        # Large components are initialised lazily (once per container)
        self.llm = ChatOpenAI(
    ...
    def _init_vectorstore(self):
        """Attach Pinecone index to LangChain vector store."""
        try:
